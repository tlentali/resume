...
\underline{Spécialité Recherche Opérationnelle et Aide à la Décision}: 
...
\cventry{\textcolor{color2bis}{2008 -- 2012}}{Licence Mathématiques et Licence MASS}{Université de Toulon}{}{}{\underline{Mathématiques
  Pures incluant}: algèbre (linéaire, théorie des groupes, anneaux, corps),
  analyse (réel, complexe, théorie de la mesure, calcul différentiel), géométrie
  (topologie), programmation.
\underline{Mathématiques Appliquées aux Sciences Économiques et Sociales incluant}: statistiques, probabilités, économétrie, économie (micro/macro), sociologie, théorie de la décision.
 \newline{}}
...
\cvitem{\textcolor{color2bis}{Sciences}}{Participation au concours machine
  learning Cdiscount
  2015 \textit{'Catégorisation de produits pour le e-commerce'}
