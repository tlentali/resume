...
%---------------------------------------------------------
  \cventry
    {Université de Bordeaux (fr: Master 2)} % Degree
    {Maîtrise de Mathématiques Appliquées} % Institution
...
\cventry
    {Université de Toulon (fr: Licence 3)} % Degree
    {Baccalauréat de Mathématiques Appliquées} % Institution
...
\cventry
    {Université de Toulon (fr: Licence 3)} % Degree
    {Baccalauréat de Mathématiques Pures} % Institution
    {Toulon, France} % Location
