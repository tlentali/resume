...
de la pertinence moteur (tests AB), personnalisation client de la page d'acceuil (classification).
...
\begin{itemize}
\item Mathématiques
  Pures incluant: algèbre (linéaire, théorie des groupes, anneaux, corps),
  analyse (réelle, complexe, théorie de la mesure, calcul différentiel), géométrie
  (topologie), programmation.
\item Mathématiques Appliquées aux Sciences Économiques et Sociales incluant:\\ statistiques, probabilités, économétrie, économie (micro/macro), sociologie, théorie de la décision.
 \newline{}
...
\cvitem{\textcolor{color2bis}{Sciences}}{Concours machine
  learning Cdiscount
  2015 ``\MYhref{https://www.datascience.net/fr/challenge/20/details#tab_ranking}{\underline{Catégorisation de produits pour le e-commerce}}''
